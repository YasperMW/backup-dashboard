...
<body class="font-inter antialiased bg-gray-900 text-white">
    ...
    <nav class="bg-gray-900 text-white py-4">
        <div class="container mx-auto flex justify-between items-center px-4 md:px-0">
            <div class="text-2xl font-extrabold text-green-400">SafeGuardX</div>
    ...
    <!-- Hero Section -->
    <header class="bg-gray-900 pt-16 pb-20">
        <div class="container mx-auto flex flex-col md:flex-row items-center justify-between px-4 md:px-0">
            ...
            <div class="md:w-1/2 text-left mb-12 md:mb-0">
                <h1 class="text-5xl lg:text-6xl font-extrabold leading-tight mb-6">
                    ...
                    <span class="block text-green-400">Launch It<br/>Beyond Threats.</span>
                </h1>
                ...
                <div class="flex flex-row items-center space-x-4">
                    <button class="bg-green-500 hover:bg-green-600 text-white px-6 py-3 rounded-lg text-base font-semibold shadow-none">Start Free Trial <span class="ml-2">→</span></button>
                    <input type="text" placeholder="" class="bg-white rounded-md h-11 w-40 border-0 outline-none" />
                </div>
            </div>
            <!-- Right Feature Cards -->
            <div class="md:w-1/2 flex justify-center md:justify-end">
                <div class="bg-gray-800 p-8 rounded-2xl shadow-2xl w-full max-w-lg border border-gray-700">
                    ...
                    <p class="text-center text-gray-400 mt-8 text-xs">Trusted by 50,000+ businesses worldwide</p>
                </div>
            </div>
        </div>
    </header>
    ...
    <section class="bg-gray-900 py-16 md:py-24">
        <div class="container mx-auto px-4 md:px-0 text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
                ...
                <div class="bg-gray-800 p-8 rounded-xl shadow-xl flex flex-col items-center text-center border border-gray-700">
                    <div class="text-green-400 text-6xl mb-4">&#128272;</div> <!-- Key icon -->
                ...
                <!-- Card 3: Instant Recovery -->
                <div class="bg-gray-800 p-8 rounded-xl shadow-xl flex flex-col items-center text-center border border-gray-700">
                    <div class="text-green-400 text-6xl mb-4">&#9889;</div> <!-- Lightning bolt icon -->
        ...
        <div class="container mx-auto flex flex-col md:flex-row items-center md:items-start justify-between px-4 md:px-0">
            ...
            <div class="md:w-1/2 mb-12 md:mb-0 md:pr-8">
                ...
                <ul class="space-y-4 text-lg text-gray-300">
                    ...
                    <li class="flex items-start">
                        <span class="text-green-400 mr-3 text-2xl mt-1">&#10003;</span>
                        <span>Cross-platform support: Windows, Linux, Mac, and Cloud environments</span>
                    </li>
                    <li class="flex items-start">
                        <span class="text-green-400 mr-3 text-2xl mt-1">&#10003;</span>
            ...
            <div class="md:w-1/2 flex justify-center md:justify-end">
                <div class="bg-gray-800 p-8 rounded-xl shadow-2xl text-center w-full max-w-md border border-gray-700">
                    ...
                    <button class="bg-green-500 hover:bg-green-600 text-white px-8 py-4 rounded-lg text-lg font-semibold w-full shadow-lg transition duration-300 ease-in-out">Start Free Trial</button>
                </div>
            </div>
        </div>
    </section>

    <!-- Ready to Secure Your Digital Future Section (Call to Action) -->
    <section class="bg-green-700 py-16 md:py-24 text-center">
        <div class="container mx-auto px-4 md:px-0">
            ...
            <button class="bg-white hover:bg-gray-100 text-green-700 px-8 py-4 rounded-lg text-lg font-semibold shadow-xl transition duration-300 ease-in-out">Get Started Free</button>
        </div>
    </section>
    ...
    <footer class="bg-gray-900 py-12 text-white">
        ...
        <div class="container mx-auto text-center text-gray-500 text-xs mt-12 border-t border-gray-700 pt-8">
            <p>&copy; 2024 SafeGuardX. All rights reserved.</p>
        </div>
    </footer>
