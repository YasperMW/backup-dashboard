...
<img src="{{ asset('images/logo.png') }}" alt="SafeGuardX Logo" class="h-20 w-20 object-contain">
  ...
  <!-- Hero Section -->
<header class="pt-16 pb-4 bg-cover bg-center relative" style="background-image: url('{{ asset('images/image.png') }}');"
  ...
  <!-- Call to Action Section -->
   <section class="bg-green-700 py-16 md:py-24 text-center" class="absolute inset-0 opacity-80" class="pt-16 pb-4 bg-cover bg-center relative" style="background-image: url('{{ asset('images/foot-background.jpg') }}');">
